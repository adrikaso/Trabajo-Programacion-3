...
const getByCategory = (category) => Product.find({ category }).populate('category');
...
module.exports = { getAll, getById, create, update, remove, getProductDetails, getByCategory };